...
class Order(View):
    def get(self, request, *args, **kwargs):
        ...
        Biryani = MenuItem.objects.filter(
            category__name__contains='Biryani')
        ...
        Frenchfries=MenuItem.objects.filter(category__name__contains='Frenchfries')
...
class MenuSearch(View):
    def get(self,request,*args,**kwargs):
        ...
        menu_items = MenuItem.objects.filter(Q(name__icontains=query) | Q(price__icontains=query) | Q(description__icontains=query) )
        context = {"menu_items":menu_items}
        return render(request, 'customer/menu.html', context)
